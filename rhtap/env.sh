...
export GITOPS_REPO_URL=https://github.com/rhtap-test-organization-jk/xxvcpsb1y-java-quarkus-gitops
...
export REKOR_HOST=${REKOR_HOST-https://rekor-server-rhtap-tas.apps.cluster-7pxk4.7pxk4.sandbox2369.opentlc.com}
...
export TUF_MIRROR=${TUF_MIRROR-https://tuf-rhtap-tas.apps.cluster-7pxk4.7pxk4.sandbox2369.opentlc.com}
